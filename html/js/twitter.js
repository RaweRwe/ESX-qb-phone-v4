...
$(document).on('click', '.twitter-header-tab', function (e) {
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab === "twitter-mentions") {
            $.post('http://gov-phone/ClearMentions');
        }
        ...
        if (PressedTwitterTab == "twitter-self") {
            $.post('http://gov-phone/GetSelfTweets', JSON.stringify({}), function (selfdata) {
        ...
        $.post('http://gov-phone/GetSelfTweets', JSON.stringify({}), function (selfTweets) {
...
$(document).on('click', '.tweet-delete', function (e) {
    ...
    console.log(id)
    $.post('http://gov-phone/DeleteTweet', JSON.stringify({
        id: id,
    }));

    $.post('http://gov-phone/GetSelfTweets', JSON.stringify({}), function (tweets) {
...
$(document).on('click', '#send-tweet', function (e) {
    ...
    if (TweetMessage != "" || TweetUrl != "") {
        ...
        $.post('http://gov-phone/PostNewTweet', JSON.stringify({
...
$(document).on('click', '#send-photo', function (e) {
    ...
    $.post('http://gov-phone/PostNewImage', JSON.stringify({}),
        function (url) {
...
$(document).on('click', '.hashtag-tag-text', function (e) {
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://gov-phone/GetHashtagMessages', JSON.stringify({
            hashtag: Hashtag
